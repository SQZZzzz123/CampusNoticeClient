/****************************************************************************
** Meta object code from reading C++ file 'http_manager.h'
**
...
#error "The header file 'http_manager.h' doesn't include <QObject>."
...
template <> constexpr inline auto HttpManager::qt_create_metaobjectdata<qt_meta_tag_ZN11HttpManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'noticesReceived'
        QtMocHelpers::SignalData<void(const QList<Notice> &)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Signal 'noticeDetailReceived'
        QtMocHelpers::SignalData<void(const Notice &)>(5, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
...
void HttpManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->noticesReceived((*reinterpret_cast< std::add_pointer_t<QList<Notice>>>(_a[1]))); break;
        case 1: _t->noticeDetailReceived((*reinterpret_cast< std::add_pointer_t<Notice>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (HttpManager::*)(const QList<Notice> & )>(_a, &HttpManager::noticesReceived, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (HttpManager::*)(const Notice & )>(_a, &HttpManager::noticeDetailReceived, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (HttpManager::*)(const QString & )>(_a, &HttpManager::requestFailed, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (HttpManager::*)()>(_a, &HttpManager::requestTimeout, 3))
            return;
    }
}
...
// SIGNAL 0
void HttpManager::noticesReceived(const QList<Notice> & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 0, nullptr, _t1);
}

// SIGNAL 1
void HttpManager::noticeDetailReceived(const Notice & _t1)
{
    QMetaObject::activate<void>(this, &staticMetaObject, 1, nullptr, _t1);
}

// SIGNAL 2
void HttpManager::requestFailed(const QString & _t1)
{
