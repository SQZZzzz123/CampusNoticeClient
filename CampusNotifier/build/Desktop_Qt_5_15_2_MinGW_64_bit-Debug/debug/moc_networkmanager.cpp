...
QT_MOC_LITERAL(3, 26, 21), // "QVector<Notification>"
QT_MOC_LITERAL(4, 48, 4), // "data"
QT_MOC_LITERAL(5, 53, 10), // "onFinished"
QT_MOC_LITERAL(6, 64, 14), // "QNetworkReply*"
QT_MOC_LITERAL(7, 79, 5) // "reply"

    },
    "NetworkManager\0dataReady\0\0"
    "QVector<Notification>\0data\0onFinished\0"
...
void NetworkManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dataReady((*reinterpret_cast< QVector<Notification>(*)>(_a[1]))); break;
        ...
        {
            using _t = void (NetworkManager::*)(QVector<Notification> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&NetworkManager::dataReady)) {
                *result = 0;
                return;
            }
        }
